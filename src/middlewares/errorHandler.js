 ...
 * This middleware should be placed as very bottom of the middleware stack.
 *
 * @param {Object} req
 * @param {Object} res
 */
...
/**
 * To handle errors from body parser fro cases such as invalid JSON sent through the body
